    ...
    movieArray: Array<any> = [
      {
        ...
        synopsis: 'In late summer 1945, guests are gathered for the wedding reception of Don Vito Corleones daughter Connie Talia Shire and Carlo Rizzi (Gianni Russo). Vito...',
        genres: ['Crime', 'Drama'],
        year: 1972,
